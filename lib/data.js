...
export const SITE_DATA = {
  ...
  projects: [
    { name: "Tripz.go", url: "https://tripz.page", desc: "Hiking tour platform with Telegram mini app. Organizing group trips to mountains, waterfalls and peaks around Tashkent region.", tech: "Next.js, Telegram Bot API, Vercel", status: "building" },
    { name: "Coffee.Co", url: "#", desc: "Loyalty & cashback system for coffee shops. QR-based customer identification, SMS notifications via Eskiz.uz, Loyverse POS integration.", tech: "React, Node.js, Loyverse API, Eskiz SMS", status: "in reconstruction" },
    ...
    { name: "Gilamchi", url: "#", desc: "Carpet shop management system. Full inventory, sales tracking, and reporting dashboard.", tech: "FastAPI, PostgreSQL, React TypeScript", status: "active" },
  ],
  articles: [
