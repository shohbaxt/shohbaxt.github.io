...
export const SITE_DATA = {
  ...
  projects: [
    ...
    { name: "Coffee.Co", url: "https://coffeeco.uz", desc: "Loyalty & cashback system for coffee shops. QR-based customer identification, SMS notifications via Eskiz.uz, Loyverse POS integration.", tech: "React, Node.js, Loyverse API, Eskiz SMS", status: "in reconstruction" },
